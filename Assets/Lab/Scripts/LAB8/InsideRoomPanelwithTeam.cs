...
public class InsideRoomPanelwithTeam : InsideRoomPanel
{
    ...
    protected override void SetupPlayerList(Player p, GameObject instanceEntry)
    {
        ...
        instanceEntry.GetComponent<PlayerListEntrywithTeam>().Initialize(p.ActorNumber,
        p.NickName, this.isTeamMode);
    }
    public override void SetupPlayerEnteredRoom(Player newPlayer, GameObject
    instanceEntry)
    {
