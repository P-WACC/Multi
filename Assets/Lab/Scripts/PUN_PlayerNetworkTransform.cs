...
public class PUN_PlayerNetworkTransform : MonoBehaviourPun, IPunObservable
{
    ...
    private void InterpolateMovement()
    {
        ...
        transform.position = Vector3.Lerp(transform.position, _networkPosition, Time.deltaTime *
        interpolationSpeed);
        transform.rotation = Quaternion.Slerp(transform.rotation, _networkRotation, Time.deltaTime *
        interpolationSpeed);
